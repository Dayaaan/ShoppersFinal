...
use Shop\ProductsBundle\Entity\Image;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('ShopProductsBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('Shop\ProductsBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('Shop\ProductsBundle\Form\ImageType', $image);
